  ...
  const technologyDescription = [
      ...
      description: (
        ...
        >
          ...
          >
            ...
            <SwiperSlide>
              <a href="https://faithfullthebrand.vercel.app" target="_blank">
                <img className="" src={FathfullTheBrand} alt="image slide 3" />
              </a>
            </SwiperSlide>
            <SwiperSlide>
              <a href="https://registerapi.vercel.app" target="_blank">
                <img className="" src={RegisterApi} alt="image slide 3" />
              </a>
            </SwiperSlide>
          </Swiper>
        </div>
      ...
      description: (
        <div key="html5">
          ...
          <span className="ml-16 block">
            Foi com um simples código que eu vi minhas ideias sendo transcritas
    ...
    },
    {
      ...
      description: (
        <div>
          <p key="react">
            According to its official slogan, React is a library for building
            user interfaces. React is not a framework – it's not even web-only.
            It is used with other libraries for rendering in certain
            environments. For example, React Native can be used for building
            mobile applications; React 360 can be used to build virtual reality
            applications; and many other possibilities.
          </p>
          <div className="mt-8 w-full">
            <div className={`w-[${counter}%] bg-slate-100`}>{counter}</div>
            <div className="flex ">
              <button
                onClick={() => {
    ...
    },
    {
      ...
      description: (
        <p key="nodejs">
          Node.js is a cross-platform javascript execution environment that
          allows developers to produce network and server-side applications
          using JavaScript.
        </p>
      ),
    },
    {
      ...
      description: (
        <p key="python">
          ...
          multi-paradigm approach, meaning it supports procedural,
          object-oriented, and some functional programming constructs.
        </p>
      ),
    },
  ];
        ...
        <li
          ...
          className={
            htmlSelect
              ...
              : "w-16 md:w-20 hover:text-html hover:animate-pulse"
          }
        >
          <DiHtml5 size={"100%"} />
        </li>
        ...
        <li
          ...
          className={
            javascriptSelect
              ...
              : "w-16 md:w-20 hover:text-javascript hover:animate-pulse"
          }
        >
        ...
        <li
          ...
          className={
            reactSelect
              ...
              : "w-16 md:w-20 hover:text-react hover:animate-pulse"
          }
        >
          <DiReact size={"100%"} />
        </li>
        <li
          ...
          className={
            nodejsSelect
              ...
              : "w-16 md:w-20 hover:text-nodejs hover:animate-pulse"
          }
        >
        ...
        <li
          ...
          className={
            pythonSelect
              ...
              : "w-16 md:w-20 hover:text-python hover:animate-pulse"
          }
        >
          <DiPython size={"100%"} />
        </li>
